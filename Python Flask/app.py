...
def welcome():
    ...
    return(
        ...
        f" <img width='600' src='https://www.housingwire.com/wp-content/uploads/2020/08/AdobeStock_300251965-e1596655507791.jpeg'/ >"
        ...
        f"List of data for Perth suburb, date sold, land area and price </a></li><br/><br/>"
